...
public class CarRentalSystemDemo implements Runnable{
    public void run() {
        ...
        if (!availableCars.isEmpty()) {
            ...
            if (reservation != null) {
                ...
                if (paymentSuccess) {
                    System.out.println("Reservation successful. Reservation ID: " + reservation.getReservation_id());
                } else {
                    System.out.println("Payment failed. Reservation canceled.");
                    rentalSystem.cancelReservation(reservation.getReservation_id());
                }
            } else {
    ...
    public static void main(String args[]){
        ...
        CarRentalSystemDemo carRentalSystemDemo = new CarRentalSystemDemo();
        Thread t1 = new Thread(carRentalSystemDemo);
        t1.start();
    }
}